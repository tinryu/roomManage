...
class AddRoomScreen extends BaseAddScreen<Room> {
  const AddRoomScreen({super.key, super.initialItem})
    : super(
        title: initialItem == null ? 'Add Room' : 'Edit Room',
        submitButtonText: initialItem == null ? 'Add Room' : 'Update Room',
      );
  @override
...
//               : null,
//           tenantId: tenantId,
//           imageUrl: widget.initialRoom?.imageUrl,
//         );
//       } else {
